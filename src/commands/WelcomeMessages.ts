...
export class WelcomeMessages extends Command {
    ...
    constructor() {
        super("welcome", PermissionLevel.Owner, "Edits welcome messages");
    }
    ...
    async run(bot: PantherBot, message: Message, args: string[]): Promise<CommandResult> {
        ...
        let embed: MessageEmbed = new MessageEmbed()
            ...
            .addField("Twitch", "https://www.twitch.tv/poisonedpanther", false)
            .addField("YouTube", "https://www.youtube.com/poisonedpanther", false)
            .addField("Twitter", "https://www.twitter.com/poisonedpanther", false)
