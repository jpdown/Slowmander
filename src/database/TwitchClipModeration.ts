...
export class TwitchClipModeration {
    ...
    public getChannelConfig(
        channel: Channel
    ): TwitchClipModConfig | null | undefined {
        try {
            const row: TwitchClipModConfig | undefined = this.db
                .prepare(
            ...
            this.logger.error(
                "Error getting TwitchClipModConfigs from db",
                err
            );
            return null;
        }
    ...
    public getApprovedChannels(channel: Channel): string[] | null {
        try {
            ...
            this.logger.error(
                "Error getting TwitchClipApprovedChannels from db",
                err
            );
            return null;
        }
    ...
    public disable(channel: Channel): boolean {
        ...
        try {
            ...
            this.logger.error(
                "Error disabling TwitchClipModConfigs in db",
                err
            );
        }
    ...
    public enableApprovedOnly(channel: Channel): boolean {
        ...
        try {
            ...
            this.logger.error(
                "Error enabling approvedOnly TwitchClipModConfigs in db",
                err
            );
        }
    ...
    public disableApprovedOnly(channel: Channel): boolean {
        ...
        try {
            ...
            this.logger.error(
                "Error disabling approvedOnly TwitchClipModConfigs in db",
                err
            );
        }
    ...
    public addApprovedChannel(
        ...
        try {
            ...
            this.logger.error(
                "Error adding TwitchClipApprovedChannel in db",
                err
            );
        }
    ...
    public removeApprovedChannel(
        ...
        try {
            ...
            this.logger.error(
                "Error removing TwitchClipApprovedChannel in db",
                err
            );
        }
