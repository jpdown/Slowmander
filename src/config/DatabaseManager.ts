...
export class DatabaseManager {
  ...
  public async connect() {
    try {
      // const rethinkOptions: r.ConnectionOptions = {
      //   host: this.creds.rethinkHost,
      //   port: this.creds.rethinkPort,
      //   user: this.creds.rethinkUser,
      //   password: this.creds.rethinkPass,
      //   db: this.creds.rethinkDb,
      // };
    ...
    //   const dbList: string[] = await r.dbList().run(this._connection);
  ...
  public async getConnection(): Promise<undefined> {
    // if (!this._connection) {
    //   await this.connect();
    // }
